...
* [Quantum Chemistry](https://github.com/deltorobarba/sciences/blob/master/quantumchemistry.ipynb) 🧪🧬 Ground state calculation with VQE using UCCSD on H₂ and H₂O
