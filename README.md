...
*An exoplanet is a planet that orbits a star outside of our solar system. Exoplanets can be detected by observing the effects on their host stars, such as the star's "wobble" (radial velocity method) or the dimming of its light (transit method).*
