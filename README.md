...
*Single-Point Energy Calculations compute the energy and properties at a fixed geometry. Full Geometry Optimization iteratively finds minimum energy structure or equilibrium geometry of molecule. An alternative to static calculations is Molecular Dynamics (Gromacs).*
  * [Hartree-Fock (HF-SCF)](https://github.com/deltorobarba/sciences/blob/master/hartree_fock.ipynb) Wavefunction-based single-Point Energy Calculations to compute energy and properties at fixed geometry
  ...
  * [Density Functional (DFT-SCF)](https://github.com/deltorobarba/sciences/blob/master/dft_scf.ipynb) Electron-density based calculations
  * [Geometry Optimization](https://github.com/deltorobarba/sciences/blob/master/geometry_optimization.ipynb) iteratively find minimum energy structure or equilibrium geometry of molecule
...
*Quantum circuits can be built and simulated in state vector representation with [Cirq](https://quantumai.google/cirq), [Pennylane](https://pennylane.ai) or [cuStateVec](https://docs.nvidia.com/cuda/cuquantum/latest/custatevec/index.html). Alternatively, they can be simulated as tensor network representation with [cuTensorNet](https://docs.nvidia.com/cuda/cuquantum/latest/cutensornet/index.html). Simulations can include pure states or mixed states, and be noisy or noiseless. Mixed states with density matrixes using [cuDensityMat](https://docs.nvidia.com/cuda/cuquantum/latest/cudensitymat/index.html) allow for uncertainties and noisy simulations.*
