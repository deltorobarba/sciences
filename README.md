...
*Quantum algorithms can be built and simulated as circuits directly in form of state vectors with [Cirq](https://quantumai.google/cirq), [Pennylane](https://pennylane.ai) or [cuStateVec](https://docs.nvidia.com/cuda/cuquantum/latest/custatevec/index.html). Alternatively, they can be simulated by applying tensor network contractions with [cuTensorNet](https://docs.nvidia.com/cuda/cuquantum/latest/cutensornet/index.html). Simulations can include pure states or mixed states with density matrixes using [cuDensityMat](https://docs.nvidia.com/cuda/cuquantum/latest/cudensitymat/index.html). Mixed states allow for uncertainties and noisy simulations.*
