...
*Quantum sensing, utilizing a measurement protocol on a quantum state $\rho$ and its complex conjugate, can achieve an exponential advantage in certain shadow tomography tasks compared to traditional machine learning methods that rely on multiple copies of the state with only minimal quantum memory for learning displacement amplitudes.*
